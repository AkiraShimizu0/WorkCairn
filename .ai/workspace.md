...
- `go/internal/*`: Go Domain、Service、Kernel、Adapter境界、Scheduler、通常Task PromptBuilder、Claude Runner Adapter、Vault Context／TaskStore／Deliverable／Audit Adapter、Go Runtime composition。新しい中核ルールの実装先
