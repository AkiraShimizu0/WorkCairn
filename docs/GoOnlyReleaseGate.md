...
| Interaction Session | `interaction-start-*`、`interaction-plan-generate`、`interaction-answer`、`interaction-plan-apply` | OK | request／plan digest承認、質問block、Session CAS、Ledger replay、temporary Vault／Mock Provider E2E |
